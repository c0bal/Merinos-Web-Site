...
class HolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hole" do
    assert_difference("Hole.count") do
      post holes_url, params: { hole: { number: @hole.number, round_id: @hole.round_id, score: @hole.score } }
    end
  ...
  test "should update hole" do
    patch hole_url(@hole), params: { hole: { number: @hole.number, round_id: @hole.round_id, score: @hole.score } }
